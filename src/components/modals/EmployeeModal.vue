<template>
    ...
    <div id="defaultModal" tabindex="-1"
        class="hidden bg-gray-700 bg-opacity-60 overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
